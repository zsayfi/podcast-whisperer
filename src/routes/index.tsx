        ...
        >
          <div className="flex items-center gap-2 rounded-full bg-background/70 px-4 py-2">
            ...
            <textarea
              ...
              rows={1}
              className="h-10 min-w-0 flex-1 resize-none overflow-y-auto bg-transparent py-2.5 text-sm leading-5 text-foreground placeholder:text-muted-foreground focus:outline-none disabled:opacity-60"
            />
          </div>
          <button
            type="submit"
